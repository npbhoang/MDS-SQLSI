...
public interface DatamodelsPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ATTRIBUTE__IS_ID = PROPERTY_FEATURE_COUNT + 1;
	...
	/**
	 * Returns the meta object for the attribute '{@link datamodels.Attribute#isIsID <em>Is ID</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Is ID</em>'.
	 * @see datamodels.Attribute#isIsID()
	 * @see #getAttribute()
	 * @generated
	 */
