...
public class DatamodelsFactoryImpl extends EFactoryImpl implements DatamodelsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DatamodelsPackage.DATA_MODEL: return createDataModel();
			case DatamodelsPackage.ENTITY: return createEntity();
			case DatamodelsPackage.ASSOCIATION_END: return createAssociationEnd();
			case DatamodelsPackage.ATTRIBUTE: return createAttribute();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case DatamodelsPackage.DATA_TYPE:
				return createDataTypeFromString(eDataType, initialValue);
			case DatamodelsPackage.MULTIPLICITY:
