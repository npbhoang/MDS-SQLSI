 ...
 *   <li>{@link datamodels.impl.AttributeImpl#isIsID <em>Is ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeImpl extends PropertyImpl implements Attribute {
	...
	public void setIsID(boolean newIsID) {
		...
		isID = newIsID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatamodelsPackage.ATTRIBUTE__IS_ID, oldIsID, isID));
	}
