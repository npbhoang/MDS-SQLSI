 ...
 *   <li>{@link securitymodels.impl.ProtectedResourceImpl#getProperty <em>Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProtectedResourceImpl extends MinimalEObjectImpl.Container implements ProtectedResource {
	...
	public Property getProperty() {
		if (property != null && property.eIsProxy()) {
			...
			if (property != oldProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SecuritymodelsPackage.PROTECTED_RESOURCE__PROPERTY, oldProperty, property));
			}
		}
		return property;
	}
	...
	public void setProperty(Property newProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecuritymodelsPackage.PROTECTED_RESOURCE__PROPERTY, oldProperty, property));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SecuritymodelsPackage.PROTECTED_RESOURCE__NAME:
				return getName();
			case SecuritymodelsPackage.PROTECTED_RESOURCE__PROPERTY:
