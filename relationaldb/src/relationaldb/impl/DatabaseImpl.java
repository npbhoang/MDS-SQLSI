 ...
 * </p>
 * <ul>
 *   <li>{@link relationaldb.impl.DatabaseImpl#getName <em>Name</em>}</li>
...
public class DatabaseImpl extends MinimalEObjectImpl.Container implements Database {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelationaldbPackage.DATABASE__NAME, oldName, name));
	}
