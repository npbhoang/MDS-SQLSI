...
public class RelationaldbPackageImpl extends EPackageImpl implements RelationaldbPackage {
	...
	public static RelationaldbPackage init() {
		...
		Object registeredRelationaldbPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		RelationaldbPackageImpl theRelationaldbPackage = registeredRelationaldbPackage instanceof RelationaldbPackageImpl ? (RelationaldbPackageImpl)registeredRelationaldbPackage : new RelationaldbPackageImpl();
	 ...
	 * @generated
	 */
	public EAttribute getColumn_IsPrimary() {
	 ...
	 * @generated
	 */
	public EAttribute getColumn_IsForeign() {
	...
	public void initializePackageContents() {
		...
		initEReference(getColumn_Reference(), this.getTable(), null, "reference", null, 0, 1, Column.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
