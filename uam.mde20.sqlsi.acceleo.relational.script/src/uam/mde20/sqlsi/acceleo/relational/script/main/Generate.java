 ...
 *******************************************************************************/
package uam.mde20.sqlsi.acceleo.relational.script.main;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/uam/mde20/sqlsi/acceleo/relational/script/main/generate";
    ...
    public List<String> getProperties() {
         ...
         */
    	propertiesFiles.add("uam.mde20.sqlsi.acceleo.relational.script.properties.mysql");
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(RelationaldbPackage.class)) {
            // The normal package registration if your metamodel is in a plugin.
            resourceSet.getPackageRegistry().put(RelationaldbPackage.eNS_URI, RelationaldbPackage.eINSTANCE);
        }
    }
