...
public class SecurityModelParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SecurityModelGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSecurityModelAccess().getGroup_7(), "rule__SecurityModel__Group_7__0");
			...
			builder.put(grammarAccess.getSecurityModelAccess().getResourcesAssignment_6(), "rule__SecurityModel__ResourcesAssignment_6");
			builder.put(grammarAccess.getSecurityModelAccess().getResourcesAssignment_7_1(), "rule__SecurityModel__ResourcesAssignment_7_1");
