...
/**
 * This is the item provider adapter for a {@link relationaldb.Column} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ColumnItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RelationaldbPackage.Literals.COLUMN__NAME,
				 true,
				 false,
				 false,
	...
	protected void addReferencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Column_reference_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Column_reference_feature", "_UI_Column_type"),
				 RelationaldbPackage.Literals.COLUMN__REFERENCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIsPrimaryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Column_isPrimary_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Column_isPrimary_feature", "_UI_Column_type"),
				 RelationaldbPackage.Literals.COLUMN__IS_PRIMARY,
				 true,
				 false,
				 false,
	...
	protected void addIsForeignPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Column_isForeign_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Column_isForeign_feature", "_UI_Column_type"),
				 RelationaldbPackage.Literals.COLUMN__IS_FOREIGN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RelationaldbPackage.Literals.COLUMN__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public ResourceLocator getResourceLocator() {
		return RelationaldbEditPlugin.INSTANCE;
	}
