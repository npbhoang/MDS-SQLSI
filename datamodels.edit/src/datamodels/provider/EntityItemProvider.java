...
/**
 * This is the item provider adapter for a {@link datamodels.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DatamodelsPackage.Literals.ENTITY__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DatamodelsPackage.Literals.ENTITY__SUPER_ENTITY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DatamodelsPackage.Literals.ENTITY__PROPERTIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DatamodelsPackage.Literals.ENTITY__PROPERTIES,
				 DatamodelsFactory.eINSTANCE.createAssociationEnd()));

		newChildDescriptors.add
			(createChildParameter
				(DatamodelsPackage.Literals.ENTITY__PROPERTIES,
				 DatamodelsFactory.eINSTANCE.createAttribute()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return DatamodelsEditPlugin.INSTANCE;
	}
